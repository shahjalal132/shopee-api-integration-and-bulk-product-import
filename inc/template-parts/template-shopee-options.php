    ...
    <div class="row">
        ...
        <form id="shopee-options-form">
            <div class="row align-items-center mt-2">
                ...
                <div class="col-md-3">
                    <label class="form-label" for="how_many_create_orders" title="How many orders to create">
                        <?php esc_html_e( 'Create Orders', 'bulk-product-import' ); ?>
                    </label>
                </div>
                <div class="col-md-9">
                    <input type="number" class="form-control" style="max-width: 150px;"
                        name="how_many_create_orders" id="how_many_create_orders"
                        value="<?php echo esc_attr( $how_many_create_orders ); ?>">
                </div>
            </div>
            ...
            <div class="row align-items-center mt-3">
                ...
                <div class="col-md-3">
                    <label class="form-label" for="how_many_update_orders" title="How many orders to update">
                        <?php esc_html_e( 'Update Orders', 'bulk-product-import' ); ?>
                    </label>
                </div>
                <div class="col-md-9">
                    <input type="number" class="form-control" style="max-width: 150px;"
                        name="how_many_update_orders" id="how_many_update_orders"
                        value="<?php echo esc_attr( $how_many_update_orders ); ?>">
                </div>
            </div>
